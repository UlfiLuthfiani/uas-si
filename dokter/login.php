...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $conn->query("SELECT * FROM users WHERE username = '$username' AND role = 'dokter'");
...
<head>
    ...
    <title>Login Dokter - MEDKLIK</title>
    <style>
...
<body>
    <div class="login-card">
        ...
        <div class="title"><h2>Login Dokter</h2></div>
        <div class="subtitle">Masuk ke portal dokter</div>
